...
#ifndef PAPERLIBRARY_SHELLUTILS_H
#define PAPERLIBRARY_SHELLUTILS_H
...
#if HAVE_DBUS
inline constexpr QLatin1StringView kPerProcessDbusPrefix("io.github.todd866.paperlibrary.Instance_");
